...
void send_midi(uint8_t midiNota, uint8_t midiForca, uint8_t midiCanal){
    usart_send_blocking(USART2, 0xB0 + 0x02);
    usart_send_blocking(USART2, midiNota);
    usart_send_blocking(USART2, midiForca);    
}
